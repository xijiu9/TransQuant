...
def main():
    ...
    if args.config_name:
        pretrainedConfig = AutoConfig.from_pretrained(args.config_name)
    ...
    if args.model_name_or_path:
        PreTrainedModel = AutoModelForQuestionAnswering.from_pretrained(
        ...
        PreTrainedModel = AutoModelForQuestionAnswering.from_config(config)
